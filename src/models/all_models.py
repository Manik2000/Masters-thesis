...
def generate_cnn_lstm_attention(N=15):
    ...
    cnn_lstm_model.add(Conv1D(filters=128, kernel_size=3, activation='relu', padding='same'))
    cnn_lstm_model.add(Conv1D(filters=64, kernel_size=3, activation='relu', padding='same'))
